													...
													<div class="row">
														...
														<div class="col-md-6">
															<fieldset class="form-group">
																...
																<p style="color:red;"> ${thongBaoTrungTaiKhoan } </p>
															</fieldset>
														</div>
														...
														<div class="col-md-6">
															<fieldset class="form-group">
																...
																<input type="text" value="" name="tenkhachhang"placeholder="Nguyễn Văn An" pattern="[A-Za-z].*" title="Tên Không Được Nhập Số Hoặc Kí Tự Đặt Biệt" required>
															</fieldset>
														</div>
													</div>
													<div class="row">
														...
														<div class="col-md-6 ">
															<fieldset class="form-group">
																...
																<input type="text" name="dienthoai" pattern="[0-9]{10}" title="Số điện thoại có 10 số" required>
															</fieldset>
														</div>
														...
														<div class="col-md-4 ">
															<fieldset class="form-group">
																<label>Địa chỉ</label>
																<input type="text" value="" name="diaChi" pattern="[A-Za-z0-9].*" title="Địa Chỉ Không Được Nhập Kí Tự Đặt Biệt" required>
															</fieldset>
														</div>
